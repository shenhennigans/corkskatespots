...
<?php
    ...
    $secretKey = "6Lf8oTwbAAAAAEwPI9z7rGpOHiiYMTCcRZ3UnlU5";
    ...
    if($responseKeys["success"]) {
        ...
        // Query
        $sql = "UPDATE LocationsECR SET Name='$Name', Type='$Type', Level='$Level', Surface_Type='$SurfaceType' WHERE Id = '$Id'";
        
        // Evaluate query status
